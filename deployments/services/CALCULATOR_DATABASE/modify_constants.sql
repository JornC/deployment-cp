...
UPDATE system.layer_capabilities SET url = 'http://localhost:8080/calculator/aerius-geo-wms?' WHERE layer_capabilities_id = '1';
UPDATE system.layer_capabilities SET url = 'http://localhost:8181/geoserver-calculator/wms?' WHERE layer_capabilities_id = '4';
